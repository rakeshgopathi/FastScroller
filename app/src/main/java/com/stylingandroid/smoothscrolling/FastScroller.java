...
public class FastScroller extends LinearLayout {
    ...
    private void setPosition(float y) {
        ...
        int v=getValueInRange(0, height - bubbleHeight, (int) ((height - bubbleHeight) * position));
        bubble.setY(v);
        int handleHeight = handle.getHeight();
        int v1;
            v1=getValueInRange(0, height - handleHeight, (int) ((height - handleHeight-bubbleHeight) * position));
